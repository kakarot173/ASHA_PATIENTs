...
//        navigationItem.leftBarButtonItems = [exitButtonItem, emptyButtonItem]
    ...
    private func logOut() {
        QBRequest.logOut(successBlock: { [weak self] response in
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + .seconds(1)) {
                AppDelegate.shared.chatRootViewController.showLoginScreen()
            }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            let ChatsVc = storyboard.instantiateViewController(withIdentifier: "ChatViewController") as! ChatViewController
