...
class MockData {
    static func createMockAppointment() -> [DotAppointmentModel] {
        ...
        mockAppointments.append(DotAppointmentModel(appointment_id: 1, patient_id: 1, doctor_slot_id: 1, facility_slot_id: 1, payment_id: 1, purpose: "Nose Bleeding", remarks: "Remarks Given", status: "Scheduled", payment_amount: 1000, provider_id: 1, provider_name: "Dr. Anna Jhonshon", provider_type: "Provider Type", slot_date: "6 Aug 2020", start_time: "02:00", end_time: "02:45"))
         mockAppointments.append(DotAppointmentModel(appointment_id: 1, patient_id: 1, doctor_slot_id: 1, facility_slot_id: 1, payment_id: 1, purpose: "Nose Bleeding", remarks: "Remarks Given", status: "Scheduled", payment_amount: 1000, provider_id: 1, provider_name: "Dr. Anna Jhonshon", provider_type: "Provider Type", slot_date: "6 Aug 2020", start_time: "02:00", end_time: "02:45"))
         mockAppointments.append(DotAppointmentModel(appointment_id: 1, patient_id: 1, doctor_slot_id: 1, facility_slot_id: 1, payment_id: 1, purpose: "Nose Bleeding", remarks: "Remarks Given", status: "Scheduled", payment_amount: 1000, provider_id: 1, provider_name: "Dr. Anna Jhonshon", provider_type: "Provider Type", slot_date: "6 Aug 2020", start_time: "02:00", end_time: "02:45"))
         mockAppointments.append(DotAppointmentModel(appointment_id: 1, patient_id: 1, doctor_slot_id: 1, facility_slot_id: 1, payment_id: 1, purpose: "Nose Bleeding", remarks: "Remarks Given", status: "Scheduled", payment_amount: 1000, provider_id: 1, provider_name: "Dr. Anna Jhonshon", provider_type: "Provider Type", slot_date: "6 Aug 2020", start_time: "02:00", end_time: "02:45"))
